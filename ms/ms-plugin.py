...
func_template = """
    async def {func_name}(self, req: pb.{req_name}) -> pb.{res_name}:
    ...
    for proto_file in request.proto_file:
        ...
        for srv in proto_file.service:
            ...
            for mtd in srv.method:
                ...
                req_list.append(
                    dict_template.format(method_name=method_name, type_name=req_name)
                )
                res_list.append(
                    dict_template.format(method_name=method_name, type_name=res_name)
                )
                func_list.append(
