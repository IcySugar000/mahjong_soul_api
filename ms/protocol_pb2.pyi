...
class NotifyCustomizedContestReady(_message.Message):
    __slots__ = ("unique_id", "ready", "reason")
    UNIQUE_ID_FIELD_NUMBER: _ClassVar[int]
    READY_FIELD_NUMBER: _ClassVar[int]
    REASON_FIELD_NUMBER: _ClassVar[int]
    unique_id: int
    ready: int
    reason: int
    def __init__(self, unique_id: _Optional[int] = ..., ready: _Optional[int] = ..., reason: _Optional[int] = ...) -> None: ...

class NotifyCustomizedContestRuleModify(_message.Message):
    __slots__ = ("unique_id", "auto_match")
    UNIQUE_ID_FIELD_NUMBER: _ClassVar[int]
    AUTO_MATCH_FIELD_NUMBER: _ClassVar[int]
    unique_id: int
    auto_match: int
    def __init__(self, unique_id: _Optional[int] = ..., auto_match: _Optional[int] = ...) -> None: ...

class NotifyCustomizedContestPlanReady(_message.Message):
    __slots__ = ("game_plan",)
    GAME_PLAN_FIELD_NUMBER: _ClassVar[int]
    game_plan: CustomizedContestGamePlan
    def __init__(self, game_plan: _Optional[_Union[CustomizedContestGamePlan, _Mapping]] = ...) -> None: ...

class NotifyCustomizedContestPlanCancel(_message.Message):
    __slots__ = ("unique_id", "uuid")
    UNIQUE_ID_FIELD_NUMBER: _ClassVar[int]
    UUID_FIELD_NUMBER: _ClassVar[int]
    unique_id: int
    uuid: str
    def __init__(self, unique_id: _Optional[int] = ..., uuid: _Optional[str] = ...) -> None: ...

class Error(_message.Message):
    __slots__ = ("code", "u32_params", "str_params", "json_param", "level")
    ...
    json_param: str
    level: int
    def __init__(self, code: _Optional[int] = ..., u32_params: _Optional[_Iterable[int]] = ..., str_params: _Optional[_Iterable[str]] = ..., json_param: _Optional[str] = ..., level: _Optional[int] = ...) -> None: ...
...
class AccountActivityUpdate(_message.Message):
    __slots__ = ("mine_data", "rpg_data", "feed_data", "spot_data", "friend_gift_data", "upgrade_data", "gacha_data", "simulation_data", "combining_data", "village_data", "festival_data", "island_data", "story_data", "choose_up_data", "simulation_v2_data", "quest_crew_data", "shoot_data", "bingo_data", "snowball_data")
    ...
    SNOWBALL_DATA_FIELD_NUMBER: _ClassVar[int]
...
class CustomizedContestDetail(_message.Message):
    ...
    RANK_TYPE_FIELD_NUMBER: _ClassVar[int]
    SHOW_TEAM_RANK_FIELD_NUMBER: _ClassVar[int]
    TIED_RANK_FIELD_NUMBER: _ClassVar[int]
    ...
    match_end_time: int
    def __init__(self, unique_id: _Optional[int] = ..., contest_id: _Optional[int] = ..., contest_name: _Optional[str] = ..., state: _Optional[int] = ..., creator_id: _Optional[int] = ..., create_time: _Optional[int] = ..., start_time: _Optional[int] = ..., finish_time: _Optional[int] = ..., open: _Optional[bool] = ..., rank_rule: _Optional[int] = ..., game_mode: _Optional[_Union[GameMode, _Mapping]] = ..., private_notice: _Optional[str] = ..., observer_switch: _Optional[int] = ..., emoji_switch: _Optional[int] = ..., contest_type: _Optional[int] = ..., disable_broadcast: _Optional[int] = ..., signup_start_time: _Optional[int] = ..., signup_end_time: _Optional[int] = ..., signup_type: _Optional[int] = ..., auto_match: _Optional[int] = ..., rank_type: _Optional[int] = ..., show_team_rank: _Optional[bool] = ..., tied_rank: _Optional[int] = ..., match_start_time: _Optional[int] = ..., match_end_time: _Optional[int] = ...) -> None: ...

class CustomizedContestGamePlan(_message.Message):
    __slots__ = ("unique_id", "uuid", "ready_players", "account_ids", "game_start_time", "expired_time")
    UNIQUE_ID_FIELD_NUMBER: _ClassVar[int]
    UUID_FIELD_NUMBER: _ClassVar[int]
    READY_PLAYERS_FIELD_NUMBER: _ClassVar[int]
    ACCOUNT_IDS_FIELD_NUMBER: _ClassVar[int]
    GAME_START_TIME_FIELD_NUMBER: _ClassVar[int]
    EXPIRED_TIME_FIELD_NUMBER: _ClassVar[int]
    unique_id: int
    uuid: str
    ready_players: _containers.RepeatedScalarFieldContainer[int]
    account_ids: _containers.RepeatedScalarFieldContainer[int]
    game_start_time: int
    expired_time: int
    def __init__(self, unique_id: _Optional[int] = ..., uuid: _Optional[str] = ..., ready_players: _Optional[_Iterable[int]] = ..., account_ids: _Optional[_Iterable[int]] = ..., game_start_time: _Optional[int] = ..., expired_time: _Optional[int] = ...) -> None: ...
...
class ActivityIdTimeRecord(_message.Message):
    __slots__ = ("id", "time")
    ID_FIELD_NUMBER: _ClassVar[int]
    TIME_FIELD_NUMBER: _ClassVar[int]
    id: int
...
class ActivitySnowballData(_message.Message):
    __slots__ = ("activity_id", "level", "upgrade", "rewarded_level", "finished_level", "random_seed", "battle_id", "level_finished_count", "player_combo", "reward_records", "finish_records")
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    LEVEL_FIELD_NUMBER: _ClassVar[int]
    UPGRADE_FIELD_NUMBER: _ClassVar[int]
    REWARDED_LEVEL_FIELD_NUMBER: _ClassVar[int]
    ...
    BATTLE_ID_FIELD_NUMBER: _ClassVar[int]
    LEVEL_FINISHED_COUNT_FIELD_NUMBER: _ClassVar[int]
    PLAYER_COMBO_FIELD_NUMBER: _ClassVar[int]
    REWARD_RECORDS_FIELD_NUMBER: _ClassVar[int]
    FINISH_RECORDS_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    level: int
    upgrade: _containers.RepeatedCompositeFieldContainer[ActivitySnowballUpgrade]
    rewarded_level: _containers.RepeatedScalarFieldContainer[int]
    finished_level: _containers.RepeatedScalarFieldContainer[int]
    random_seed: int
    battle_id: str
    level_finished_count: int
    player_combo: int
    reward_records: _containers.RepeatedCompositeFieldContainer[ActivityIdTimeRecord]
    finish_records: _containers.RepeatedCompositeFieldContainer[ActivityIdTimeRecord]
    def __init__(self, activity_id: _Optional[int] = ..., level: _Optional[int] = ..., upgrade: _Optional[_Iterable[_Union[ActivitySnowballUpgrade, _Mapping]]] = ..., rewarded_level: _Optional[_Iterable[int]] = ..., finished_level: _Optional[_Iterable[int]] = ..., random_seed: _Optional[int] = ..., battle_id: _Optional[str] = ..., level_finished_count: _Optional[int] = ..., player_combo: _Optional[int] = ..., reward_records: _Optional[_Iterable[_Union[ActivityIdTimeRecord, _Mapping]]] = ..., finish_records: _Optional[_Iterable[_Union[ActivityIdTimeRecord, _Mapping]]] = ...) -> None: ...

class ActivitySnowballUpgrade(_message.Message):
    __slots__ = ("id",)
    ID_FIELD_NUMBER: _ClassVar[int]
    id: int
    def __init__(self, id: _Optional[int] = ...) -> None: ...

class ActivitySnowballUpgradeDirty(_message.Message):
    __slots__ = ("value", "dirty")
    VALUE_FIELD_NUMBER: _ClassVar[int]
    DIRTY_FIELD_NUMBER: _ClassVar[int]
    value: _containers.RepeatedCompositeFieldContainer[ActivitySnowballUpgrade]
    dirty: bool
    def __init__(self, value: _Optional[_Iterable[_Union[ActivitySnowballUpgrade, _Mapping]]] = ..., dirty: _Optional[bool] = ...) -> None: ...

class ActivitySnowballValueChanges(_message.Message):
    __slots__ = ("level", "upgrade", "rewarded_level", "finished_level", "level_finished_count", "player_combo")
    LEVEL_FIELD_NUMBER: _ClassVar[int]
    UPGRADE_FIELD_NUMBER: _ClassVar[int]
    REWARDED_LEVEL_FIELD_NUMBER: _ClassVar[int]
    FINISHED_LEVEL_FIELD_NUMBER: _ClassVar[int]
    ...
    PLAYER_COMBO_FIELD_NUMBER: _ClassVar[int]
    level: UInt32Dirty
    upgrade: ActivitySnowballUpgradeDirty
    rewarded_level: UInt32ArrayDirty
    finished_level: UInt32ArrayDirty
    level_finished_count: UInt32Dirty
    player_combo: UInt32Dirty
    def __init__(self, level: _Optional[_Union[UInt32Dirty, _Mapping]] = ..., upgrade: _Optional[_Union[ActivitySnowballUpgradeDirty, _Mapping]] = ..., rewarded_level: _Optional[_Union[UInt32ArrayDirty, _Mapping]] = ..., finished_level: _Optional[_Union[UInt32ArrayDirty, _Mapping]] = ..., level_finished_count: _Optional[_Union[UInt32Dirty, _Mapping]] = ..., player_combo: _Optional[_Union[UInt32Dirty, _Mapping]] = ...) -> None: ...

class ActivitySnowballPlayerAttackedInfo(_message.Message):
    __slots__ = ("target", "track", "damage", "critia")
    TARGET_FIELD_NUMBER: _ClassVar[int]
    TRACK_FIELD_NUMBER: _ClassVar[int]
    DAMAGE_FIELD_NUMBER: _ClassVar[int]
    CRITIA_FIELD_NUMBER: _ClassVar[int]
    target: int
    track: int
    damage: int
    critia: int
    def __init__(self, target: _Optional[int] = ..., track: _Optional[int] = ..., damage: _Optional[int] = ..., critia: _Optional[int] = ...) -> None: ...

class ActivitySnowballPlayerAction(_message.Message):
    __slots__ = ("tick", "track")
    TICK_FIELD_NUMBER: _ClassVar[int]
    TRACK_FIELD_NUMBER: _ClassVar[int]
    tick: int
    track: int
    def __init__(self, tick: _Optional[int] = ..., track: _Optional[int] = ...) -> None: ...

class ActivitySnowballPlayerState(_message.Message):
    __slots__ = ("player", "hp", "mp")
    PLAYER_FIELD_NUMBER: _ClassVar[int]
    HP_FIELD_NUMBER: _ClassVar[int]
    ...
    hp: int
    mp: int
    def __init__(self, player: _Optional[int] = ..., hp: _Optional[int] = ..., mp: _Optional[int] = ...) -> None: ...

class SnowballActivityBossAction(_message.Message):
    __slots__ = ("tick", "type", "track", "attack_info", "mp_consume_info")
    class SnowballActivityBossAttackInfo(_message.Message):
        __slots__ = ("damage", "is_con_attack")
        DAMAGE_FIELD_NUMBER: _ClassVar[int]
        IS_CON_ATTACK_FIELD_NUMBER: _ClassVar[int]
        damage: int
        is_con_attack: int
        def __init__(self, damage: _Optional[int] = ..., is_con_attack: _Optional[int] = ...) -> None: ...
    class SnowballActivityBossMPConsumeInfo(_message.Message):
        __slots__ = ("mp_consume", "before_delay", "after_delay")
        MP_CONSUME_FIELD_NUMBER: _ClassVar[int]
        BEFORE_DELAY_FIELD_NUMBER: _ClassVar[int]
        AFTER_DELAY_FIELD_NUMBER: _ClassVar[int]
        mp_consume: int
        before_delay: int
        after_delay: int
        def __init__(self, mp_consume: _Optional[int] = ..., before_delay: _Optional[int] = ..., after_delay: _Optional[int] = ...) -> None: ...
    TICK_FIELD_NUMBER: _ClassVar[int]
    TYPE_FIELD_NUMBER: _ClassVar[int]
    TRACK_FIELD_NUMBER: _ClassVar[int]
    ATTACK_INFO_FIELD_NUMBER: _ClassVar[int]
    MP_CONSUME_INFO_FIELD_NUMBER: _ClassVar[int]
    tick: int
    type: int
    track: int
    attack_info: SnowballActivityBossAction.SnowballActivityBossAttackInfo
    mp_consume_info: SnowballActivityBossAction.SnowballActivityBossMPConsumeInfo
    def __init__(self, tick: _Optional[int] = ..., type: _Optional[int] = ..., track: _Optional[int] = ..., attack_info: _Optional[_Union[SnowballActivityBossAction.SnowballActivityBossAttackInfo, _Mapping]] = ..., mp_consume_info: _Optional[_Union[SnowballActivityBossAction.SnowballActivityBossMPConsumeInfo, _Mapping]] = ...) -> None: ...

class ClientDeviceInfoLog(_message.Message):
    __slots__ = ("device_info", "login_time", "account_id")
    ...
    login_time: int
    account_id: int
    def __init__(self, device_info: _Optional[_Union[ClientDeviceInfo, _Mapping]] = ..., login_time: _Optional[int] = ..., account_id: _Optional[int] = ...) -> None: ...
...
class ResEnterCustomizedContest(_message.Message):
    __slots__ = ("error", "detail_info", "player_report", "is_followed", "state", "is_admin", "game_plan")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    ...
    is_admin: bool
    game_plan: CustomizedContestGamePlan
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., detail_info: _Optional[_Union[CustomizedContestDetail, _Mapping]] = ..., player_report: _Optional[_Union[CustomizedContestPlayerReport, _Mapping]] = ..., is_followed: _Optional[bool] = ..., state: _Optional[int] = ..., is_admin: _Optional[bool] = ..., game_plan: _Optional[_Union[CustomizedContestGamePlan, _Mapping]] = ...) -> None: ...
...
class ResFetchServerMaintenanceInfo(_message.Message):
    __slots__ = ("function_maintenance", "activity_maintenance")
    ...
    class ServerActivityMaintenanceInfo(_message.Message):
        __slots__ = ("activity_type", "open")
        ACTIVITY_TYPE_FIELD_NUMBER: _ClassVar[int]
        OPEN_FIELD_NUMBER: _ClassVar[int]
        activity_type: str
        open: bool
        def __init__(self, activity_type: _Optional[str] = ..., open: _Optional[bool] = ...) -> None: ...
    FUNCTION_MAINTENANCE_FIELD_NUMBER: _ClassVar[int]
    ACTIVITY_MAINTENANCE_FIELD_NUMBER: _ClassVar[int]
    ...
    activity_maintenance: _containers.RepeatedCompositeFieldContainer[ResFetchServerMaintenanceInfo.ServerActivityMaintenanceInfo]
    def __init__(self, function_maintenance: _Optional[_Iterable[_Union[ResFetchServerMaintenanceInfo.ServerFunctionMaintenanceInfo, _Mapping]]] = ..., activity_maintenance: _Optional[_Iterable[_Union[ResFetchServerMaintenanceInfo.ServerActivityMaintenanceInfo, _Mapping]]] = ...) -> None: ...
...
class ContestSetting(_message.Message):
    ...
    class LevelLimit(_message.Message):
        ...
        value: int
        operate: int
        def __init__(self, type: _Optional[int] = ..., value: _Optional[int] = ..., operate: _Optional[int] = ...) -> None: ...
...
class ResFetchManagerCustomizedContest(_message.Message):
    __slots__ = ("error", "name", "open_show", "game_rule_setting", "start_time", "end_time", "auto_match", "rank_rule", "check_state", "checking_name", "contest_setting", "rank_type", "season", "match_start_time", "match_end_time")
...
class ResFetchContestPlayerRank(_message.Message):
    ...
    class SeasonRank(_message.Message):
        __slots__ = ("account_id", "nickname", "data", "team_name", "modify_score")
        ACCOUNT_ID_FIELD_NUMBER: _ClassVar[int]
        NICKNAME_FIELD_NUMBER: _ClassVar[int]
        DATA_FIELD_NUMBER: _ClassVar[int]
        TEAM_NAME_FIELD_NUMBER: _ClassVar[int]
        MODIFY_SCORE_FIELD_NUMBER: _ClassVar[int]
        account_id: int
        nickname: str
        data: ResFetchContestPlayerRank.ContestPlayerAccountData
        team_name: str
        modify_score: int
        def __init__(self, account_id: _Optional[int] = ..., nickname: _Optional[str] = ..., data: _Optional[_Union[ResFetchContestPlayerRank.ContestPlayerAccountData, _Mapping]] = ..., team_name: _Optional[str] = ..., modify_score: _Optional[int] = ...) -> None: ...
    class PlayerData(_message.Message):
        __slots__ = ("rank", "data", "team_name", "modify_score")
        RANK_FIELD_NUMBER: _ClassVar[int]
        DATA_FIELD_NUMBER: _ClassVar[int]
        TEAM_NAME_FIELD_NUMBER: _ClassVar[int]
        MODIFY_SCORE_FIELD_NUMBER: _ClassVar[int]
        ...
        team_name: str
        modify_score: int
        def __init__(self, rank: _Optional[int] = ..., data: _Optional[_Union[ResFetchContestPlayerRank.ContestPlayerAccountData, _Mapping]] = ..., team_name: _Optional[str] = ..., modify_score: _Optional[int] = ...) -> None: ...
    ERROR_FIELD_NUMBER: _ClassVar[int]
...
class ReqSnowballActivityStartBattle(_message.Message):
    __slots__ = ("activity_id",)
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    def __init__(self, activity_id: _Optional[int] = ...) -> None: ...

class ResSnowballActivityStartBattle(_message.Message):
    __slots__ = ("error", "random_seed", "boss_action", "battle_id", "player_state", "random_seq")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    RANDOM_SEED_FIELD_NUMBER: _ClassVar[int]
    BOSS_ACTION_FIELD_NUMBER: _ClassVar[int]
    BATTLE_ID_FIELD_NUMBER: _ClassVar[int]
    PLAYER_STATE_FIELD_NUMBER: _ClassVar[int]
    RANDOM_SEQ_FIELD_NUMBER: _ClassVar[int]
    error: Error
    random_seed: int
    boss_action: _containers.RepeatedCompositeFieldContainer[SnowballActivityBossAction]
    battle_id: str
    player_state: _containers.RepeatedCompositeFieldContainer[ActivitySnowballPlayerState]
    random_seq: _containers.RepeatedScalarFieldContainer[int]
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., random_seed: _Optional[int] = ..., boss_action: _Optional[_Iterable[_Union[SnowballActivityBossAction, _Mapping]]] = ..., battle_id: _Optional[str] = ..., player_state: _Optional[_Iterable[_Union[ActivitySnowballPlayerState, _Mapping]]] = ..., random_seq: _Optional[_Iterable[int]] = ...) -> None: ...

class ReqSnowballActivityFinishBattle(_message.Message):
    __slots__ = ("activity_id", "player_action", "result", "battle_id")
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    PLAYER_ACTION_FIELD_NUMBER: _ClassVar[int]
    RESULT_FIELD_NUMBER: _ClassVar[int]
    BATTLE_ID_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    player_action: _containers.RepeatedCompositeFieldContainer[ActivitySnowballPlayerAction]
    result: int
    battle_id: str
    def __init__(self, activity_id: _Optional[int] = ..., player_action: _Optional[_Iterable[_Union[ActivitySnowballPlayerAction, _Mapping]]] = ..., result: _Optional[int] = ..., battle_id: _Optional[str] = ...) -> None: ...

class ResSnowballActivityFinishBattle(_message.Message):
    __slots__ = ("error", "changes")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    CHANGES_FIELD_NUMBER: _ClassVar[int]
    error: Error
    changes: ActivitySnowballValueChanges
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., changes: _Optional[_Union[ActivitySnowballValueChanges, _Mapping]] = ...) -> None: ...

class ReqSnowballActivityUpgrade(_message.Message):
    __slots__ = ("activity_id", "upgrade")
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    UPGRADE_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    upgrade: _containers.RepeatedCompositeFieldContainer[ActivitySnowballUpgrade]
    def __init__(self, activity_id: _Optional[int] = ..., upgrade: _Optional[_Iterable[_Union[ActivitySnowballUpgrade, _Mapping]]] = ...) -> None: ...

class ResSnowballActivityUpgrade(_message.Message):
    __slots__ = ("error", "changes")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    CHANGES_FIELD_NUMBER: _ClassVar[int]
    error: Error
...
class ReqSnowballActivityReceiveReward(_message.Message):
    __slots__ = ("activity_id", "level")
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    LEVEL_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    level: _containers.RepeatedScalarFieldContainer[int]
    def __init__(self, activity_id: _Optional[int] = ..., level: _Optional[_Iterable[int]] = ...) -> None: ...

class ResSnowballActivityReceiveReward(_message.Message):
    __slots__ = ("error", "changes", "rewards")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    CHANGES_FIELD_NUMBER: _ClassVar[int]
    REWARDS_FIELD_NUMBER: _ClassVar[int]
    error: Error
    changes: ActivitySnowballValueChanges
    rewards: _containers.RepeatedCompositeFieldContainer[ExecuteReward]
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., changes: _Optional[_Union[ActivitySnowballValueChanges, _Mapping]] = ..., rewards: _Optional[_Iterable[_Union[ExecuteReward, _Mapping]]] = ...) -> None: ...
...
class ReqAuthGame(_message.Message):
    __slots__ = ("account_id", "token", "game_uuid", "device")
    ACCOUNT_ID_FIELD_NUMBER: _ClassVar[int]
    TOKEN_FIELD_NUMBER: _ClassVar[int]
    GAME_UUID_FIELD_NUMBER: _ClassVar[int]
    DEVICE_FIELD_NUMBER: _ClassVar[int]
    ...
    game_uuid: str
    device: ClientDeviceInfo
    def __init__(self, account_id: _Optional[int] = ..., token: _Optional[str] = ..., game_uuid: _Optional[str] = ..., device: _Optional[_Union[ClientDeviceInfo, _Mapping]] = ...) -> None: ...
